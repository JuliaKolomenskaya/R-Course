...
new %>%
ggplot(aes(SUBTLWF,Mean_RT))+geom_point(aes(color=Length))+scale_color_continuous(low = "lightblue", high = "red")+facet_wrap(~POS) + scale_x_log10()#+scale_x_continuous(limits=c(0,101),breaks = c(1,100))+theme_bw()
```
